...
//               Sign up to create professional resumes and get interview-ready.
//             </p>
//           </div>
//         </motion.section>
    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <motion.section
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1.5 }}
          className="relative flex h-80 sm:h-96 lg:h-full items-end bg-gray-900 lg:col-span-5 xl:col-span-6"
        >
          <img
            alt="Interview preparation"
            src="/signup.jpeg"
          ...
          <div className="relative p-6 text-center lg:text-left lg:p-12">
        ...
        >
          ...
          <div className="flex w-full h-full items-center justify-center">
            <motion.div
              ...
              className="w-full max-w-xs sm:max-w-sm mx-auto flex justify-center" // 🔹 added flex + justify-center
            >
              <SignUp />
            </motion.div>
          </div>
